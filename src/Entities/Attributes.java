    ...
    private String verifyExcess(Attribute key, Integer value)
    {
        ...
        switch (key)
        {
            case DEFENSE:
                ...
                else if(this.containsKey(Attribute.DEFENSE) && value >= (int)(this.get(Attribute.STRENGTH)*2) || value >= (int)(this.get(Attribute.DEXTERITY)*2))
                {
            ...
            case DEXTERITY:
                ...
                else if(this.containsKey(Attribute.DEXTERITY) && value >= (int)(this.get(Attribute.STRENGTH)*2))
                {
            ...
            case SPEED:
                ...
                else if(this.containsKey(Attribute.SPEED) && value >= (int)(this.get(Attribute.STRENGTH)*1.5) || value >= (int)(this.get(Attribute.DEXTERITY)*1.5))
                {
            ...
            case STRENGTH:
                ...
                else if(this.containsKey(Attribute.STRENGTH) && value >= (int)(this.get(Attribute.DEFENSE)*1.5) || value >= (int)(this.get(Attribute.DEXTERITY)*2))
                {
